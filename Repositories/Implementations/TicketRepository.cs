...
namespace Repositories.Implementations
{
    public class TicketRepository : ITicketRepository
    {
        ...
        public async Task UpdateAsync(Ticket ticket) { _context.Entry(ticket).State = EntityState.Modified; await _context.SaveChangesAsync(); }
        public async Task DeleteAsync(int id) { var t = await GetByIdAsync(id); if (t != null) { _context.Tickets.Remove(t); await _context.SaveChangesAsync(); } }
    }
}
