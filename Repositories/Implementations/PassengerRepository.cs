...
namespace Repositories.Implementations
{
    public class PassengerRepository : IPassengerRepository
    {
        ...
        public async Task UpdateAsync(Passenger passenger) { _context.Entry(passenger).State = EntityState.Modified; await _context.SaveChangesAsync(); }
        public async Task DeleteAsync(int id) { var p = await GetByIdAsync(id); if (p != null) { _context.Passengers.Remove(p); await _context.SaveChangesAsync(); } }
    }
}
